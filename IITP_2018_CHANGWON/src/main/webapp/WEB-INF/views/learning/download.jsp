...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function exportProgress(exportID) {		
				...
				$.ajax({
					type :'post',
					url : '${pageContext.request.contextPath}/learning/downloadProcessing.do',
			...
			var downloadCheck = function (){
				$.ajax({type :'post',
						url: '${pageContext.request.contextPath}/learning/downloadInfo.do',
	...
	<body class="pop_body type_02">
		<div>
			...
			<div class="pop_content clear2" style="margin-top: 20px;">
				...
				<div class="pop_download_area mt_10">
					...
					<img id="progress" src="${pageContext.request.contextPath}/resources/images/common/loading.gif" class="pop_down_loading" style="display:none;" alt="다운로드 진행중" />
		...
		<form name="downloadForm" action="${pageContext.request.contextPath}/learning/download.do" method="post">
