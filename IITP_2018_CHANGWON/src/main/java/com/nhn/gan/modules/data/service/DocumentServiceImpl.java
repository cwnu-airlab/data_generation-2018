...
import com.nhn.gan.common.utils.file.FileInfo;
import com.nhn.gan.common.utils.file.FileUpload;
...
import com.nhn.gan.modules.data.dao.DocumentDao;
import com.nhn.gan.modules.work.service.HistoryService;

@Service("documentService")
public class DocumentServiceImpl implements DocumentService{

	@Value("#{app['file.uploadPath']}") private String uploadfile;
	
	@Autowired public DocumentDao documentDao;
	...
	public List<DocumentVo> getDocSubjectGroupList(DocumentVo vo) throws Exception {
		return documentDao.getDocSubjectGroupList(vo);
	}
