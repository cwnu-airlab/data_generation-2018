...
public class CollectionServiceImpl implements CollectionService{
	...
	@Override
	public String domainJstreeHtml(Integer colId, String contextPath) throws Exception {
		List<CollectionVo> list = getCollectionList();
        ...
        return new JsTree.Mapper("colId", "path").parseAsHtml(list, selId, contextPath);
	}
